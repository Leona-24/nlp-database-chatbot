...
- **Dual-Layer Architecture**: Uses **Llama 3.1 (8B)** via Groq as primary intelligence with a custom **Smart Heuristic Engine** as a robust fallback.
...
- **AI Stack**:
  - **Primary**: Llama 3.1 8B (State-of-the-art LLM)
...
- **Llama 3.1 8B**: Provides human-like understanding of complex data requests and nuance, far exceeding standard pattern matching.
